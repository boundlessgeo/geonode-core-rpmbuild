...
BuildRequires: gcc make expat-devel gdbm-devel sqlite-devel readline-devel zlib-devel db4-devel bzip2-devel openssl-devel tk-devel
AutoReq: no
Prefix: %{__prefix}
...
%changelog
* Thu Nov 03 2016 BerryDaniel <dberry@boundlessgeo.com> [2.7.12-1]
- Updated to 2.7.12
